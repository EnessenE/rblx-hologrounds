-- general stats --
	...
	_G.SoundBase=.85 _G.SoundDivider=1.4
	...
	_G.Stats={["maxaccuracy"]=0.2, ["minaccuracy"]=0.02, ["firerate"]=0.235,["heat"]=7.5,["cool"]=4.5,
	["aimflaw"]=48,["reposition"]=25,["firepos"]=Vector3.new(-0.165,0,-2.2),["firemode"]="Burst", ["canscope"]=false, ["scopeid"]=""}
	...
	_G.DMG=(function(range) damage=6.5 return damage end)
