-- general stats --
	...
	_G.SoundBase=1 _G.SoundDivider=2.3
	...
	_G.Stats={["maxaccuracy"]=0.24, ["minaccuracy"]=0.09, ["firerate"]=0.06,["heat"]=1,["cool"]=2.25,
	["aimflaw"]=5,["reposition"]=7,["firepos"]=Vector3.new(0,0,-2.75),["firemode"]="Auto", ["canscope"]=false, ["scopeid"]=""}
	...
	_G.DMG=(function(range) damage=5.5 return damage end)
