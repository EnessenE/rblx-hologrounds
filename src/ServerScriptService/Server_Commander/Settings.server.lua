...
_G.admins			={"enes130", "player1"}
_G.banned			={"Gorehowl", "Maritimes", "davidsantiago123", "rafaanthony1"}
_G.bannedgroups	={}
_G.groups			={	3747606,	}
_G.ranks			={	196,	} --(194 - Lieutenants+)(193 - Sentinels+)
_G.hrteamranks		={	199,	}
_G.hrteam			="nil" --To disable change it to: hrteam = nil

_G.account_age		=-1 	--How old does an account need to be (in days) to join? Set to -1 to disable.
